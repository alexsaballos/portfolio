...
export const PROJECTS = {
    ...
    atx: {
        ...
        categories: ["pic32", "pic18", "pickit5", "ni_elvis", "robotics", "automation", "embedded_systems", "cad"],
        privacy: "private",
        client: "academic",
    ...
    arctos: {
        ...
        categories: ["arduino_mega_2560_r3", "ni_elvis", "robotics"],
        privacy: "private",
        client: "academic",
        organization: "harding",
        status: "completed",
    ...
    maze_robot: {
        ...
        categories: ["pic18", "pickit5", "ni_elvis", "robotics", "automation", "embedded_systems", "cad"],
        privacy: "private",
        client: "academic",
        organization: "harding",
        status: "completed",
    ...
    asgc: {
        ...
        categories: ["raspberrypi_4b", "ni_elvis", "robotics", "automation"],
        privacy: "private",
        client: "academic",
        organization: "nasa",
        status: "completed",
    ...
    digital_clock: {
        ...
        categories: ["ni_elvis", "digital_logic_design"],
        privacy: "private",
        client: "academic",
        organization: "harding",
        status: "completed",
