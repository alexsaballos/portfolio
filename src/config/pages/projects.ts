...
export const PROJECTS = {
    ...
    atx: {
        ...
        categories: ["pic32", "pic18", "robotics", "automation", "embedded_systems"],
        privacy: "private",
        client: "academic",
        status: "completed",
        featured: true,
    ...
    maze_robot: {
        ...
        categories: ["pic18", "robotics", "automation", "embedded_systems"],
        privacy: "private",
        client: "academic",
        status: "completed",
        featured: true,
    ...
    asgc: {
        ...
        categories: ["robotics", "automation", "embedded_systems"],
        privacy: "private",
        client: "academic",
        status: "completed",
        featured: false,
